return {
  ...
  config = function ()
    ...
    wk.setup({
      ignore_missing = true, -- Ignore any keybindings not explicitly defined
    })
    ...
    wk.register({
      ...
      mode = "t", -- Set the mode for these keybindings to "terminal" mode
      prefix = "<leader>", -- No prefix for these keybindings
      buffer = nil, -- Global keybindings, not specific to a buffer
    })
